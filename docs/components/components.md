...
| Chango Private Admin          | 2.1.0                             | 
| Chango Private Streaming      | 2.1.0                             | 
| Chango Private Data API       | 2.1.0                             | 
| Chango Private Trino Gateway  | 2.1.0                             | 
| Chango Private Authorizer     | 2.1.0                             | 
| Chango Private REST Catalog   | 2.1.0                             |
