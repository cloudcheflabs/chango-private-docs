...
Download Chango Private distribution.
```agsl
curl -L -O https://github.com/cloudcheflabs/chango-libs/releases/download/chango-private-deps/chango-private-2.1.0.tar.gz
```

And tar the file and move to the installation directory of Chango Private.

```agsl
tar zxvf chango-private-2.1.0.tar.gz 
cd chango-private-2.1.0/ansible/
```
